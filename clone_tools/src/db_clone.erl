...
-define(VIEWS, [{<<"filtered_ids">>, wh_json:from_list([{<<"map">>, <<"function(doc) { if (doc.pvt_deleted || doc.pvt_type == 'cdr' || doc.pvt_type == 'vmbox' || doc.pvt_type == 'debit' || doc.pvt_type == 'credit' || doc.pvt_type == 'acdc_stat') return; emit(doc._id, null); }">>}])}
